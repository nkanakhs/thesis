<section class="main-container py-5">
    <div class="container">   
        <div id="create_course">
            <form method="POST" action="<?php echo URL; ?>AdminController/CreateDepartment2" name="professorform">
                <h4 class="text-center font-weight-bold"> <?php echo t_new_department_description;?> </br> </h4>
